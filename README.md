...
class Talha:
    def __init__(self):
        ...
        self.databases   = ["MongoDB", "MySQL", "Pinecone", "Chroma", "FAISS"]
        self.tools       = ["FastAPI", "Node.js", "Docker", "Apache Airflow", "n8n"]
        self.frameworks  = ["LangChain", "LangGraph", "HuggingFace"]
        self.interests   = ["Agentic AI", "Vector Databases", "Automation Pipelines"]

    def current_mission(self):
        return "Building AI systems that think, reason and act 🚀"
...
<div align="center">
  ...
  <p><i>Hand-picked projects I'm most proud of</i></p>
</div>
